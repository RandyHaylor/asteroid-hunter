...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Eo(e,t,n){let r=new Float32Array(fo),i=new W(0,1,0);return new Ki({name:`SphericalGaussianBlur`,defines:{n:fo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ko(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Do(){return new Ki({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ko(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Oo(){return new Ki({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ko(),fragmentShader:`
...
`)}var tc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function nc(e,t){let n=tc[t];return n===void 0?(B(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var rc=new W;function ic(){return K.getLuminanceCoefficients(rc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${rc.x.toFixed(4)}, ${rc.y.toFixed(4)}, ${rc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
</svg>`,Zd=new W,Qd=new W;function $d(e){let t=new Map;function n(n){let r=t.get(n);if(!r){r=document.createElement(`div`),r.className=`enemyTargetRing`;let i=document.createElement(`div`);i.className=`enemyTargetRingSpinner`,i.innerHTML=Xd,r.appendChild(i),e.appendChild(r),t.set(n,r)}return r}return{updateEnemyTargetRings(r,i,a,o,s){let c=new Set;for(let e of r){Zd.copy(e.positionMeters).applyMatrix4(i.matrixWorldInverse);let t=Zd.z>0;Qd.copy(e.positionMeters).project(i);let r=Qd.x,l=Qd.y;t&&(r=-r,l=-l);let u=!t&&Math.abs(r)<=1&&Math.abs(l)<=1,d;if(u)d=qd;else{d=Jd;let e=Math.max(Math.abs(r),Math.abs(l));if(e===0)l=Yd;else{let t=Yd/e;r*=t,l*=t}}let f=(r*.5+.5)*a,p=(-l*.5+.5)*o,m=n(e.contactSignatureId);c.add(e.contactSignatureId);let h=e.contactState===`lastSeenFading`;m.style.width=`${d}px`,m.style.height=`${d}px`,m.style.left=`${f}px`,m.style.top=`${p}px`,m.style.display=`block`,m.classList.toggle(`enemyTargetRingLastSeen`,h),m.style.opacity=h?`${.3+.6*e.fadeRemainingFraction}`:`1`,m.classList.toggle(`enemyTargetRingLocked`,e.contactSignatureId===s)}for(let[n,r]of t)c.has(n)||(e.removeChild(r),t.delete(n))}}}function ef(e){let t=document.createElement(`div`);return t.className=`aimingReticle`,e.appendChild(t),{setEngaged(e){t.classList.toggle(`aimingReticleEngaged`,e)}}}var tf=new W,nf=new W;function rf(e){let t=document.createElement(`div`);t.className=`sunLensFlareCore`,e.appendChild(t);let n=document.createElement(`div`);n.className=`sunLensFlareGhost`,e.appendChild(n);function r(){t.style.display=`none`,n.style.display=`none`}return{updateSunLensFlare(e,i,a,o){if(tf.copy(e).applyMatrix4(i.matrixWorldInverse),tf.z>0){r();return}nf.copy(e).project(i);let s=nf.x,c=nf.y;if(Math.abs(s)>1.2||Math.abs(c)>1.2){r();return}let l=a,u=o,d=(s*.5+.5)*l,f=(-c*.5+.5)*u,p=l-d,m=u-f,h=Math.max(0,Math.min(1,1.2-Math.max(Math.abs(s),Math.abs(c))));t.style.display=`block`,t.style.left=`${d}px`,t.style.top=`${f}px`,t.style.opacity=`${h}`,n.style.display=`block`,n.style.left=`${p}px`,n.style.top=`${m}px`,n.style.opacity=`${h*.5}`}}}var af=2048,of=1024;function sf(e){let t=e%2147483647;return t<=0&&(t+=2147483646),function(){return t=t*16807%2147483647,(t-1)/2147483646}}var cf=[`rgba(120, 40, 180, 0.55)`,`rgba(40, 120, 200, 0.5)`,`rgba(200, 60, 130, 0.45)`,`rgba(40, 180, 170, 0.4)`,`rgba(210, 120, 40, 0.35)`];function lf(){let e=document.createElement(`canvas`);e.width=af,e.height=of;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,0,of);n.addColorStop(0,`#0c1430`),n.addColorStop(.5,`#161033`),n.addColorStop(1,`#0a1428`),t.fillStyle=n,t.fillRect(0,0,af,of);let r=sf(1337);t.globalCompositeOperation=`lighter`;for(let e=0;e<26;e++){let e=r()*af,n=r()*of,i=140+r()*420,a=cf[Math.floor(r()*cf.length)],o=t.createRadialGradient(e,n,0,e,n,i);o.addColorStop(0,a),o.addColorStop(1,`rgba(0, 0, 0, 0)`),t.fillStyle=o,t.fillRect(0,0,af,of)}for(let e=0;e<1400;e++){let e=r()*af,n=r()*of,i=r(),a=i>.97?1.8:.9;t.fillStyle=`rgba(255, 255, 255, ${.25+i*.65})`,t.beginPath(),t.arc(e,n,a,0,Math.PI*2),t.fill()}t.globalCompositeOperation=`source-over`;let i=new wi(e);return i.mapping=303,i.colorSpace=Ie,i}function uf(e){let t=document.createElement(`div`);t.className=`powerUpSelectionBackdrop`;let n=document.createElement(`div`);n.className=`powerUpSelectionTitle`,n.textContent=`CHOOSE AN UPGRADE`,t.appendChild(n);let r=document.createElement(`div`);r.className=`powerUpSelectionCardRow`,t.appendChild(r),e.appendChild(t);function i(){t.classList.remove(`powerUpSelectionBackdropVisible`),r.replaceChildren()}return{showPowerUpChoices(e,n){r.replaceChildren();for(let t of e){let e=document.createElement(`button`);e.className=`powerUpSelectionCard`;let i=document.createElement(`div`);i.className=`powerUpSelectionCardIcon`,i.innerHTML=t.iconSvgMarkup;let a=document.createElement(`div`);a.className=`powerUpSelectionCardName`,a.textContent=t.displayName;let o=document.createElement(`div`);o.className=`powerUpSelectionCardDescription`,o.textContent=t.description,e.appendChild(i),e.appendChild(a),e.appendChild(o),e.addEventListener(`click`,()=>{n(t)}),r.appendChild(e)}t.classList.add(`powerUpSelectionBackdropVisible`)},hide:i}}function df(e){return`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${e}</svg>`}var ff=[{powerUpId:`speedBoost`,displayName:`SPEED BOOST`,description:`+18% top speed & thrust`,iconSvgMarkup:df(`<path d="M4 5l7 7-7 7"/><path d="M13 5l7 7-7 7"/>`),applyToPlayerStats(){hl.maxForwardSpeedMetersPerSecond*=1.18,hl.maxThrustNewtons*=1.18}},{powerUpId:`tractorDistance`,displayName:`TRACTOR RANGE`,description:`+20% tractor grab distance`,iconSvgMarkup:df(`<circle cx="4" cy="12" r="2"/><path d="M6 12h11"/><path d="M14 8l4 4-4 4"/>`),applyToPlayerStats(){gl.tractorGrabMaxRangeMeters*=1.2}},{powerUpId:`laserDamage`,displayName:`LASER DAMAGE`,description:`+30% laser bolt damage`,iconSvgMarkup:df(`<path d="M13 2L4 14h6l-1 8 9-12h-6z"/>`),applyToPlayerStats(){Yu.boltDamage*=1.3}},{powerUpId:`missileDamage`,displayName:`MISSILE DAMAGE`,description:`+30% missile explosion damage`,iconSvgMarkup:df(`<circle cx="12" cy="12" r="3"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3M5 5l2 2M17 17l2 2M19 5l-2 2M7 17l-2 2"/>`),applyToPlayerStats(){Xu.explosionDamage*=1.3}},{powerUpId:`missileSpeed`,displayName:`MISSILE SPEED`,description:`+25% missile flight speed`,iconSvgMarkup:df(`<path d="M14 4c3 1 5 4 5 7l-4 4c-3 0-6-2-7-5z"/><path d="M3 12h4M3 16h5M3 8h3"/>`),applyToPlayerStats(){Xu.missileSpeedMetersPerSecond*=1.25}},{powerUpId:`autoAimPower`,displayName:`AUTO-AIM POWER`,description:`+30% auto-aim lock cone`,iconSvgMarkup:df(`<circle cx="12" cy="12" r="8"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4"/><circle cx="12" cy="12" r="2"/>`),applyToPlayerStats(){$u.coneHalfAngleRadians*=1.3}},{powerUpId:`missileFireRate`,displayName:`MISSILE RATE`,description:`−20% missile cooldown`,iconSvgMarkup:df(`<circle cx="12" cy="13" r="8"/><path d="M12 13V9M9 2h6"/>`),applyToPlayerStats(){Xu.fireCooldownSeconds*=.8}},{powerUpId:`missileTrackingTurn`,displayName:`MISSILE TRACKING`,description:`+50% missile homing turn rate`,iconSvgMarkup:df(`<path d="M5 19c0-8 6-12 13-12"/><path d="M14 3l4 4-4 4"/>`),applyToPlayerStats(){Xu.homingTurnRateRadiansPerSecond*=1.5}}];function pf(e,t){if(e.length<2)throw Error(`selectTwoDistinctPowerUps requires at least two power-ups to choose from`);let n=e.slice(),r=Math.floor(t()*n.length),[i]=n.splice(r,1),a=Math.floor(t()*n.length),[o]=n.splice(a,1);return[i,o]}var mf=new W,hf=new W;function gf(e,t,n,r,i){mf.copy(t).sub(e);let a=n.lengthSq()-r*r,o=2*mf.dot(n),s=mf.lengthSq(),c=0;if(Math.abs(a)<1e-6)c=Math.abs(o)>1e-6?-s/o:-1;else{let e=o*o-4*a*s;if(e>=0){let t=Math.sqrt(e),n=(-o-t)/(2*a),r=(-o+t)/(2*a);c=n>0?n:r}else c=-1}return!(c>0)||!Number.isFinite(c)?i.copy(mf).normalize():(hf.copy(t).addScaledVector(n,c),i.copy(hf).sub(e).normalize())}var _f=4,vf=3,yf=3,bf=.25,xf=new Oi(bf,bf,yf),Sf=new Lr({color:6750190}),Cf=new Lr({color:16733508}),wf=new W(0,0,1),Tf=new W,Ef=new W,Df=new Dt,Of=new W(0,1,0),kf=new W(1,0,0);function Af(e){let t=[];function n(n){let r=t[n];e.remove(r.boltMesh),t[n]=t[t.length-1],t.pop()}return{tryFireLaserVolley(n,r,i,a,o){Tf.crossVectors(r,Of),Tf.lengthSq()<1e-6&&Tf.crossVectors(r,kf),Tf.normalize();let s=Math.max(1,i.simultaneousBoltCount);for(let c=0;c<s;c++){let l=s===1?0:c/(s-1)-.5;Df.setFromAxisAngle(Tf,l*i.spreadAngleRadians),Ef.copy(r).normalize().applyQuaternion(Df);let u=new J(xf,a?Sf:Cf);u.position.copy(n),u.quaternion.setFromUnitVectors(wf,Ef),e.add(u),t.push({boltMesh:u,velocityMetersPerSecond:Ef.clone().multiplyScalar(i.boltSpeedMetersPerSecond),distanceTraveledMeters:0,maxRangeMeters:i.maxRangeMeters,boltDamage:i.boltDamage,firedByPlayer:a,firedAtSeconds:o})}return!0},updateLaserBolts(e,r,i,a,o){for(let s=t.length-1;s>=0;s--){let c=t[s];if(c.boltMesh.position.addScaledVector(c.velocityMetersPerSecond,e),c.distanceTraveledMeters+=c.velocityMetersPerSecond.length()*e,c.distanceTraveledMeters>c.maxRangeMeters){n(s);continue}let l=c.boltMesh.position,u=!1;for(let e of r)if(!e.isDestroyed&&!(l.distanceToSquared(e.positionMeters)>e.currentRadiusMeters*e.currentRadiusMeters)){o.onAsteroidHit(e,l,c.boltDamage),u=!0;break}if(!u&&c.firedByPlayer){for(let e of i)if(!e.isDestroyed&&!(l.distanceToSquared(e.positionMeters)>_f*_f)){o.onEnemyHitByPlayer(e,c.boltDamage),u=!0;break}}else !u&&!c.firedByPlayer&&l.distanceToSquared(a)<=vf*vf&&(o.onPlayerHit(c.boltDamage),u=!0);u&&n(s)}}}}var jf=4,Mf=3,Nf=25,Pf=.45,Ff=1.6,If=.3,Lf=.7,Rf=new Ai(If,If,Ff,8),zf=new ji(If,Lf,8),Bf=new Li(.45,8,6),Vf=new Li(1,16,12),Hf=new Lr({color:12312046}),Uf=new Lr({color:14527129}),Wf=new Lr({color:16755251,transparent:!0,opacity:.9,blending:2,depthWrite:!1}),Gf=new W(0,0,1),Kf=new W,qf=new W,Jf=new W,Yf=new W,Xf=new Dt;function Zf(e,t){let n=e.homingTarget;if(!n||n.isDestroyed)return;let r=e.velocityMetersPerSecond.length();if(r<1e-6||(qf.copy(e.velocityMetersPerSecond).divideScalar(r),Jf.copy(n.positionMeters).sub(e.missileMesh.position),Jf.lengthSq()<1e-6))return;Jf.normalize();let i=qf.angleTo(Jf);if(i<1e-4||(Yf.crossVectors(qf,Jf),Yf.lengthSq()<1e-10))return;Yf.normalize();let a=Math.min(i,e.homingTurnRateRadiansPerSecond*t);Xf.setFromAxisAngle(Yf,a),e.velocityMetersPerSecond.applyQuaternion(Xf),e.missileMesh.quaternion.setFromUnitVectors(Gf,qf.copy(e.velocityMetersPerSecond).divideScalar(r))}function Qf(e){let t=new wn,n=e?Hf:Uf,r=new J(Rf,n);r.rotation.x=Math.PI/2,t.add(r);let i=new J(zf,n);i.rotation.x=Math.PI/2,i.position.z=2.3/2,t.add(i);let a=new J(Bf,Wf);return a.position.z=-1.6/2,t.add(a),t}function $f(e){let t=[],n=[];function r(n){let r=t[n];e.remove(r.missileMesh),t[n]=t[t.length-1],t.pop()}function i(t,r){let i=new Lr({color:16742195,transparent:!0,opacity:.8,blending:2,depthWrite:!1}),a=new J(Vf,i);a.position.copy(t),a.scale.setScalar(.01),e.add(a),n.push({fireballMesh:a,fireballMaterial:i,ageSeconds:0,maxRadiusMeters:r})}function a(e,t,n,r,a){let o=e.missileMesh.position,s=e.explosionRadiusMeters*e.explosionRadiusMeters;for(let n of t)n.isDestroyed||o.distanceToSquared(n.positionMeters)>(e.explosionRadiusMeters+n.currentRadiusMeters)*(e.explosionRadiusMeters+n.currentRadiusMeters)||a.onAsteroidHit(n,o,e.explosionDamage);if(e.firedByPlayer)for(let t of n)t.isDestroyed||o.distanceToSquared(t.positionMeters)>s||a.onEnemyHitByPlayer(t,e.explosionDamage);o.distanceToSquared(r)<=s&&a.onPlayerHit(e.explosionDamage),i(o,e.explosionRadiusMeters)}function o(e,t,n,r){let i=e.missileMesh.position;for(let e of t)if(!e.isDestroyed&&i.distanceToSquared(e.positionMeters)<=e.currentRadiusMeters*e.currentRadiusMeters)return!0;if(e.firedByPlayer){for(let e of n)if(!e.isDestroyed&&i.distanceToSquared(e.positionMeters)<=jf*jf)return!0;return!1}return i.distanceToSquared(r)<=Mf*Mf}return{tryFireMissile(n,r,i,a,o,s=null){Kf.copy(r).normalize();let c=Qf(a);return c.position.copy(n),c.quaternion.setFromUnitVectors(Gf,Kf),e.add(c),t.push({missileMesh:c,velocityMetersPerSecond:Kf.clone().multiplyScalar(i.missileSpeedMetersPerSecond),ageSeconds:0,explosionRadiusMeters:i.explosionRadiusMeters,explosionDamage:i.explosionDamage,firedByPlayer:a,firedAtSeconds:o,homingTarget:s,homingTurnRateRadiansPerSecond:i.homingTurnRateRadiansPerSecond}),!0},updateMissiles(i,s,c,l,u){for(let e=t.length-1;e>=0;e--){let n=t[e];if(Zf(n,i),n.missileMesh.position.addScaledVector(n.velocityMetersPerSecond,i),n.ageSeconds+=i,n.ageSeconds>Nf){r(e);continue}o(n,s,c,l)&&(a(n,s,c,l,u),r(e))}for(let t=n.length-1;t>=0;t--){let r=n[t];r.ageSeconds+=i;let a=Math.min(1,r.ageSeconds/Pf);r.fireballMesh.scale.setScalar(Math.max(.01,a*r.maxRadiusMeters)),r.fireballMaterial.opacity=.8*(1-a),a>=1&&(e.remove(r.fireballMesh),r.fireballMaterial.dispose(),n[t]=n[n.length-1],n.pop())}}}}function ep(e,t){let n=document.createElement(`div`);n.className=`weaponCooldownBar ${t}`;let r=document.createElement(`div`);return r.className=`weaponCooldownFill`,n.appendChild(r),e.appendChild(n),r}function tp(e){let t=document.createElement(`div`);t.className=`weaponCooldownPanel`,e.appendChild(t);let n=ep(t,`weaponCooldownBarLaser`),r=ep(t,`weaponCooldownBarMissile`);function i(e,t){let n=Math.max(0,Math.min(1,t));e.style.width=`${n*100}%`,e.parentElement?.classList.toggle(`weaponCooldownBarReady`,n>=1)}return{updateWeaponCooldownIndicators(e,t){i(n,e),i(r,t)}}}var np=`
...
</svg>`;function rp(e){let t=document.createElement(`div`);return t.className=`cockpitFrameOverlay`,t.innerHTML=np,e.appendChild(t),{setCockpitFrameVisible(e){t.classList.toggle(`cockpitFrameOverlayVisible`,e)}}}var ip=3811898,ap=6750020;function op(){let e=new wn,t=new Ji({color:ip,flatShading:!0}),n=new Ji({color:1061640,emissive:ap,emissiveIntensity:1.8}),r=new J(new Pi(1,0),t);r.scale.set(1.1,.7,2.5),e.add(r);for(let r of[-1,1]){let i=new J(new ji(.45,2.6,4),t);i.position.set(r*1.7,0,.7),i.rotation.x=Math.PI/2,e.add(i);let a=new J(new Li(.28,6,4),n);a.position.set(r*1.7,0,-.7),e.add(a)}let i=new J(new Oi(.9,.16,.3),n);i.position.set(0,.25,-1.3),e.add(i);let a=new J(new Li(.4,8,6),n);a.position.set(0,0,2.3),a.scale.z=.6,e.add(a);let o=new J(new Oi(.12,1.1,1.6),t);return o.position.set(0,.8,.9),o.rotation.x=-.35,e.add(o),e}function sp(e,t){if(e.isDestroyed)return;let n=Math.min(e.shieldPointsRemaining,t);e.shieldPointsRemaining-=n;let r=t-n;e.hitPointsRemaining=Math.max(0,e.hitPointsRemaining-r),e.hitPointsRemaining<=0&&(e.isDestroyed=!0)}function cp(){return{wantsToFireLaser:!1,wantsToFireMissile:!1,aimDirectionWorld:new W(0,0,-1)}}var lp=40,up=2,dp=1,fp=1.2,pp=.5,mp=1300,hp=30,gp=30,_p=Math.cos(25*Math.PI/180),vp=380,yp=50,bp=120,xp=250,Sp=900,Cp=12,wp=50,Tp=5,Ep=8,Dp=2,Op=20,kp=.6,Ap=new WeakMap;function jp(e){let t=Ap.get(e);return t||(t={patrolWaypointMeters:new W,hasPatrolWaypoint:!1,coverAsteroid:null,coverAsteroidRadiusWhenChosenMeters:0,hidePointMeters:new W,peekGoalPointMeters:new W,secondsUntilNextPeek:0,peekSecondsRemaining:0,isPeeking:!1},Ap.set(e,t)),t}var Mp=1;function Np(e,t,n){let r=op();return r.position.copy(t),n.add(r),{enemyShipId:Mp++,behaviorTier:e,positionMeters:t.clone(),velocityMetersPerSecond:new W,orientation:new Dt,shieldPointsRemaining:40,hitPointsRemaining:60,isDestroyed:!1,renderObject:r}}function Pp(e,t,n){return n.copy(e.positionMeters).sub(t),n.lengthSq()<1e-9&&n.set(0,0,1),n.normalize().multiplyScalar(e.currentRadiusMeters+Cp).add(e.positionMeters)}var Fp=new W(0,0,-1),Ip=new W(0,1,0),Lp=new W(1,0,0),Rp=new W(0,0,0),zp=new W,Bp=new W,Vp=new W,Hp=new W,Up=new W,Wp=new W,Gp=new W,Kp=new W,qp=new W,Jp=new Yt,Yp=new Dt;function Xp(e,t,n,r,i){if(i.wantsToFireLaser=!1,i.wantsToFireMissile=!1,e.isDestroyed)return;let a=jp(e);zp.copy(n).sub(e.positionMeters);let o=zp.length();o>1e-6?i.aimDirectionWorld.copy(zp).divideScalar(o):i.aimDirectionWorld.copy(Fp).applyQuaternion(e.orientation);let s=!Ru(e.positionMeters,n,t),c;switch(e.behaviorTier){case`dumbPatrol`:c=$p(e,a,o,s,i,Vp);break;case`orbitStrafe`:c=em(e,n,o,s,i,Vp);break;case`coverHunter`:c=rm(e,a,t,n,o,s,r,i,Vp);break}Zp(e,Vp,c,r),i.wantsToFireLaser||i.wantsToFireMissile?Qp(e,i.aimDirectionWorld,r):e.velocityMetersPerSecond.lengthSq()>pp*pp&&(qp.copy(e.velocityMetersPerSecond).normalize(),Qp(e,qp,r)),e.renderObject.position.copy(e.positionMeters),e.renderObject.quaternion.copy(e.orientation)}function Zp(e,t,n,r){Hp.copy(t).sub(e.positionMeters);let i=Hp.length();if(i>1e-6){let e=Math.min(n,i*dp);Hp.multiplyScalar(e/i)}else Hp.set(0,0,0);Up.copy(Hp).sub(e.velocityMetersPerSecond).multiplyScalar(up),Up.length()>lp&&Up.setLength(lp),e.velocityMetersPerSecond.addScaledVector(Up,r),e.positionMeters.addScaledVector(e.velocityMetersPerSecond,r)}function Qp(e,t,n){Jp.lookAt(Rp,t,Ip),Yp.setFromRotationMatrix(Jp),e.orientation.rotateTowards(Yp,fp*n)}function $p(e,t,n,r,i,a){return(!t.hasPatrolWaypoint||e.positionMeters.distanceTo(t.patrolWaypointMeters)<hp)&&(t.patrolWaypointMeters.randomDirection().multiplyScalar(Math.cbrt(Math.random())*mp),t.hasPatrolWaypoint=!0),a.copy(t.patrolWaypointMeters),r&&n<=jl.laserShortRangeMeters&&(Bp.copy(Fp).applyQuaternion(e.orientation),Bp.dot(i.aimDirectionWorld)>=_p&&(i.wantsToFireLaser=!0)),gp}function em(e,t,n,r,i,a){return Wp.copy(e.positionMeters).sub(t),Wp.lengthSq()<1e-9&&Wp.copy(Lp),Wp.normalize(),Gp.crossVectors(Wp,Ip),Gp.lengthSq()<1e-9&&Gp.crossVectors(Wp,Lp),Gp.normalize(),a.copy(t).addScaledVector(Wp,vp).addScaledVector(Gp,bp),r&&(n<=jl.laserShortRangeMeters&&(i.wantsToFireLaser=!0),n>=xp&&n<=Sp&&(i.wantsToFireMissile=!0)),yp}function tm(e,t,n,r){let i=null,a=1/0;for(let e of n){if(e.isDestroyed||e.sizeClass!==`large`)continue;let n=e.positionMeters.distanceToSquared(t.positionMeters);n<a&&(a=n,i=e)}e.coverAsteroid=i,e.isPeeking=!1,e.secondsUntilNextPeek=Tp+Math.random()*(Ep-Tp),i&&(e.coverAsteroidRadiusWhenChosenMeters=i.currentRadiusMeters,Pp(i,r,e.hidePointMeters))}function nm(e,t){let n=e.coverAsteroid;if(!n)return;e.isPeeking=!0,e.peekSecondsRemaining=Dp,Kp.copy(n.positionMeters).sub(t).cross(Ip),Kp.lengthSq()<1e-9&&Kp.copy(n.positionMeters).sub(t).cross(Lp),Kp.lengthSq()<1e-9&&Kp.copy(Lp);let r=Math.random()<.5?-1:1;e.peekGoalPointMeters.copy(e.hidePointMeters).addScaledVector(Kp.normalize(),r*(n.currentRadiusMeters+Op))}function rm(e,t,n,r,i,a,o,s,c){let l=t.coverAsteroid;return(!l||l.isDestroyed||l.currentRadiusMeters<kp*t.coverAsteroidRadiusWhenChosenMeters||!Ru(r,t.hidePointMeters,n))&&tm(t,e,n,r),t.coverAsteroid?(t.isPeeking?(t.peekSecondsRemaining-=o,t.peekSecondsRemaining<=0&&(t.isPeeking=!1,t.secondsUntilNextPeek=Tp+Math.random()*(Ep-Tp))):(t.secondsUntilNextPeek-=o,t.secondsUntilNextPeek<=0&&nm(t,r)),c.copy(t.isPeeking?t.peekGoalPointMeters:t.hidePointMeters),a&&(i<=jl.laserShortRangeMeters?s.wantsToFireLaser=!0:i>=xp&&i<=Sp&&(s.wantsToFireMissile=!0)),wp):$p(e,t,i,a,s,c)}var im=7,am=.55,om=6,sm=90,cm=.35,lm=new Fi(1,1),um=new Lr({color:1054752,transparent:!0,opacity:.6,side:2}),dm=new Lr({color:4500223,side:2}),fm=new Lr({color:16729156,side:2});function pm(e,t){let n=Math.max(1e-4,Math.min(1,t));e.scale.x=n*im,e.position.x=-((1-n)*im)/2}function mm(){let e=new wn,t=.8500000000000001/2,n=-.42500000000000004,r=new J(lm,um);r.scale.set(im,am,1),r.position.y=t,e.add(r);let i=new J(lm,um);i.scale.set(im,am,1),i.position.y=n,e.add(i);let a=new J(lm,dm);a.scale.set(im,am*.7,1),a.position.set(0,t,.01),e.add(a);let o=new J(lm,fm);return o.scale.set(im,am*.7,1),o.position.set(0,n,.01),e.add(o),{barsGroup:e,shieldFillMesh:a,hullFillMesh:o}}var hm=new W;function gm(e){let t=new Map;return{updateEnemyConditionBars(n,r){let i=new Set;hm.set(0,1,0).applyQuaternion(r.quaternion);let a=r.position;for(let o of n){if(o.isDestroyed)continue;let n=t.get(o.enemyShipId);n||(n=mm(),e.add(n.barsGroup),t.set(o.enemyShipId,n)),i.add(o.enemyShipId);let s=o.positionMeters.distanceTo(a),c=Math.max(cm,s/sm);n.barsGroup.position.copy(o.positionMeters).addScaledVector(hm,om*c),n.barsGroup.quaternion.copy(r.quaternion),n.barsGroup.scale.setScalar(c),pm(n.shieldFillMesh,o.shieldPointsRemaining/40),pm(n.hullFillMesh,o.hitPointsRemaining/60)}for(let[n,r]of t)i.has(n)||(e.remove(r.barsGroup),t.delete(n))},getActiveBarCount(){return t.size}}}function _m(){let e=100,t=100,n=-1/0;return{applyIncomingWeaponDamage(r,i){let a=Math.min(e,r);e-=a;let o=r-a;t=Math.max(0,t-o),n=i},updateShieldRegeneration(t,r){r-n<4||(e=Math.min(100,e+20*t))},isPlayerDestroyed(){return t<=0},restoreForWaveRestart(){e=100,t=100,n=-1/0},getShieldPointsFraction(){return e/100},getHullPointsFraction(){return t/100}}}function vm(e){return Math.max(0,Math.min(1,e))}function ym(e){let t=document.createElement(`div`);t.className=`playerConditionPanel`,e.appendChild(t);function n(e,n,r){let i=document.createElement(`div`);i.className=`playerConditionBarRow ${n}`;let a=document.createElement(`div`);a.className=`playerConditionBarLabel`,a.textContent=e;let o=document.createElement(`div`);o.className=`playerConditionBarTrack`;let s=document.createElement(`div`);return s.className=`playerConditionBarFill ${r}`,o.appendChild(s),i.appendChild(a),i.appendChild(o),t.appendChild(i),{barTrack:o,barFill:s}}let r=n(`SHIELD`,`playerConditionSideLeft`,`playerConditionShieldFill`),i=n(`HULL`,`playerConditionSideRight`,`playerConditionHullFill`);return{updatePlayerConditionDisplay(e,t){let n=vm(e),a=vm(t);r.barFill.style.width=`${n*100}%`,i.barFill.style.width=`${a*100}%`,r.barTrack.classList.toggle(`playerConditionShieldDownPulse`,n<=0)}}}var bm=1200;function xm(){let e=new Map,t=[],n=0;function r(r,i,a,o){for(let t of e.values())t.wasDetectedThisUpdate=!1;for(let t of r){if(t.isDestroyed){e.delete(t.enemyShipId);continue}if(!(t.positionMeters.distanceTo(a)<=1200&&!Ru(a,t.positionMeters,i)))continue;let n=e.get(t.enemyShipId);n||(n={reading:{contactSignatureId:t.enemyShipId,contactType:`enemy`,contactState:`visible`,positionMeters:new W,fadeRemainingFraction:1},lastSeenAtSeconds:o,wasDetectedThisUpdate:!0},e.set(t.enemyShipId,n)),n.wasDetectedThisUpdate=!0,n.lastSeenAtSeconds=o,n.reading.contactState=`visible`,n.reading.fadeRemainingFraction=1,n.reading.positionMeters.copy(t.positionMeters)}for(let[t,n]of e){if(n.wasDetectedThisUpdate)continue;let r=o-n.lastSeenAtSeconds;if(r>45){e.delete(t);continue}n.reading.contactState=`lastSeenFading`,n.reading.fadeRemainingFraction=Math.max(0,1-r/12)}t.length=0;for(let n of e.values())n.reading.fadeRemainingFraction>0&&t.push(n.reading);n=e.size}function i(){return t}function a(){return n}function o(){return n>0}return{updateRadarContacts:r,getContactReadings:i,getRecentActiveEnemyCount:a,hasUnresolvedEnemies:o}}var Sm=16724787,Cm=16763955,wm=4521864,Tm=397870,Em=.011,Dm=.009,Om=new Dt;function km(e){let t=.98,n=[];for(let r=0;r<14;r++){let i=-e+2*e*(r/14),a=-e+2*e*((r+1)/14);n.push(0,0,0),n.push(Math.sin(i)*t,0,-Math.cos(i)*t),n.push(Math.sin(a)*t,0,-Math.cos(a)*t)}let r=new Er;return r.setAttribute(`position`,new dr(new Float32Array(n),3)),r}function Am(e){let t=document.createElement(`div`);t.className=`radarControlZone`;let n=document.createElement(`canvas`);n.className=`radarControlCanvas`,t.appendChild(n);let r=document.createElement(`div`);r.className=`radarEnemyCountLabel`,r.textContent=`CONTACTS: 0`,t.appendChild(r),e.appendChild(t);let i=new Dt,a=new Dt,o=new Dt,s=new W(0,1,0),c=new W(1,0,0),l=null,u=0,d=0;n.addEventListener(`pointerdown`,e=>{l=e.pointerId,n.setPointerCapture(e.pointerId),u=e.clientX,d=e.clientY}),n.addEventListener(`pointermove`,e=>{if(e.pointerId!==l)return;let t=e.clientX-u,n=e.clientY-d;u=e.clientX,d=e.clientY,a.setFromAxisAngle(s,-t*Em),o.setFromAxisAngle(c,-n*Em),i.multiply(a).multiply(o).normalize()});function f(){l=null}n.addEventListener(`pointerup`,f),n.addEventListener(`pointercancel`,f);let p=new ml({canvas:n,antialias:!0});p.setPixelRatio(Math.min(window.devicePixelRatio,2)),p.setClearColor(Tm,1);let m=new Mn,h=new Ea(50,1,.1,10);h.position.set(0,.9,2.1),h.lookAt(0,0,0);let g=new J(new Li(1,16,12),new Lr({color:2809823,wireframe:!0,transparent:!0,opacity:.3}));m.add(g);let _=new J(km($u.coneHalfAngleRadians),new Lr({color:4521864,transparent:!0,opacity:.22,side:2,depthWrite:!1}));m.add(_);let v=new J(new ki(1,48),new Lr({color:2809823,transparent:!0,opacity:.08,side:2,depthWrite:!1}));v.rotation.x=-Math.PI/2,m.add(v);let y=new J(new Ii(.98,1,48),new Lr({color:2809823,transparent:!0,opacity:.5,side:2}));y.rotation.x=-Math.PI/2,m.add(y);let b=new J(new Li(.05,8,6),new Lr({color:8257535}));m.add(b);let x=new J(new Li(.03,6,4),new Lr({color:2809823,transparent:!0,opacity:.55}));x.position.set(0,0,-1),x.scale.set(.7,.7,3),m.add(x);let S=new Li(.045,8,6),C=new Ai(Dm,Dm,1,6),w=[],T=[];function E(e){let t=w[e];return t||(t=new J(S,new Lr({transparent:!0,depthTest:!1})),w[e]=t,m.add(t)),t}function D(e){let t=T[e];return t||(t=new J(C,new Lr({transparent:!0,depthTest:!1})),T[e]=t,m.add(t)),t}function ee(e,n,a,o,s){Om.copy(i).invert(),g.quaternion.copy(Om);for(let t=0;t<e.length;t++){let r=e[t],i=E(t);i.visible=!0,i.position.copy(r.positionMeters).sub(n.positionMeters).applyQuaternion(Om).multiplyScalar(1/bm),i.position.lengthSq()>1&&i.position.normalize(),r.contactState===`lastSeenFading`?(i.material.color.setHex(Cm),i.material.opacity=r.fadeRemainingFraction):(i.material.color.setHex(r.contactType===`friendly`?wm:Sm),i.material.opacity=1);let a=D(t),o=Math.abs(i.position.y);o<.001?a.visible=!1:(a.visible=!0,a.position.set(i.position.x,i.position.y/2,i.position.z),a.scale.set(1,o,1),a.material.color.copy(i.material.color),a.material.opacity=i.material.opacity*.75)}for(let t=e.length;t<w.length;t++)w[t].visible=!1;for(let t=e.length;t<T.length;t++)T[t].visible=!1;let c=1+.12*Math.sin(s*4);b.scale.setScalar(c),t.classList.toggle(`radarOutlineBlinking`,o),r.textContent=`CONTACTS: ${a}`,r.classList.toggle(`radarEnemyCountLabelAlert`,a>0)}let O=-1;function k(){let e=n.clientWidth;e>0&&e!==O&&(O=e,p.setSize(e,e,!1)),p.render(m,h)}return{updateRadarDisplay:ee,renderRadar:k,isSteeringDrag:()=>l!==null,getCommandedOrientation:()=>i,syncCommandedOrientationToShip:e=>{i.copy(e)}}}var jm=48;function Mm(e,t){let n=document.createElement(`div`);n.className=e;let r=document.createElement(`div`);r.className=t,n.appendChild(r);let i=null,a=0,o=0;function s(e){let t=n.getBoundingClientRect(),i=t.left+t.width/2,s=t.top+t.height/2,c=Math.max(-48,Math.min(jm,e.clientX-i)),l=Math.max(-48,Math.min(jm,e.clientY-s));r.style.transform=`translate(${c}px, ${l}px)`,a=c/jm,o=l/jm}function c(){i=null,a=0,o=0,r.style.transform=`translate(0px, 0px)`}return n.addEventListener(`pointerdown`,e=>{i=e.pointerId,n.setPointerCapture(e.pointerId),s(e)}),n.addEventListener(`pointermove`,e=>{e.pointerId===i&&s(e)}),n.addEventListener(`pointerup`,c),n.addEventListener(`pointercancel`,c),{zoneElement:n,getDeflectionX:()=>a,getDeflectionY:()=>o,isPointerActive:()=>i!==null}}function Nm(e){let t=Mm(`strafeJoystickZone`,`strafeJoystickKnob`);e.appendChild(t.zoneElement);let n=document.createElement(`div`);n.className=`throttleLeverTrack`;let r=document.createElement(`div`);r.className=`throttleLeverFill`;let i=document.createElement(`div`);i.className=`throttleLeverKnob`,n.appendChild(r),n.appendChild(i),e.appendChild(n);let a=0,o=null;function s(){let e=a*100;r.style.height=`${e}%`,i.style.bottom=`calc(${e}% - 14px)`}s();function c(e){let t=n.getBoundingClientRect(),r=1-(e.clientY-t.top)/t.height;a=Math.max(0,Math.min(1,r)),s()}n.addEventListener(`pointerdown`,e=>{o=e.pointerId,n.setPointerCapture(e.pointerId),c(e)}),n.addEventListener(`pointermove`,e=>{e.pointerId===o&&c(e)}),n.addEventListener(`pointerup`,()=>{o=null}),n.addEventListener(`pointercancel`,()=>{o=null});let l=new Set,u=.1;window.addEventListener(`keydown`,e=>{l.add(e.code),(e.code===`ShiftLeft`||e.code===`ShiftRight`)&&(a=Math.min(1,a+u),s()),(e.code===`ControlLeft`||e.code===`ControlRight`)&&(a=Math.max(0,a-u),s())}),window.addEventListener(`keyup`,e=>{l.delete(e.code)});function d(){let e=0;return(l.has(`KeyW`)||l.has(`ArrowUp`))&&(e+=1),(l.has(`KeyS`)||l.has(`ArrowDown`))&&--e,e}function f(){let e=0;return(l.has(`KeyD`)||l.has(`ArrowRight`))&&(e+=1),(l.has(`KeyA`)||l.has(`ArrowLeft`))&&--e,e}function p(){let e=0;return l.has(`KeyL`)&&(e+=1),l.has(`KeyJ`)&&--e,e}function m(){let e=0;return l.has(`KeyI`)&&(e+=1),l.has(`KeyK`)&&--e,e}return{readFlightControlInput(){return{pitchInput:d(),yawInput:f(),throttleFraction:a}},readStrafeControlInput(){let e=t.isPointerActive();return{strafeXInput:e?t.getDeflectionX():p(),strafeYInput:e?-t.getDeflectionY():m()}},setStrafeJoystickVisible(e){t.zoneElement.classList.toggle(`strafeJoystickZoneVisible`,e)},setThrottleFraction(e){a=Math.max(0,Math.min(1,e)),s()}}}var Pm=new W(0,8.5,18),Fm=30,Im=2.6,Lm=new W(0,.45,-1.2),Rm=new W,zm=new W,Bm=new W,Vm=new W,Hm=new W(0,1,0),Um=new W(0,0,-1);function Wm(e){let t=!1,n=`thirdPersonChase`,r=!1,i=1;function a(n,a,o){let s=r?Im:1,c=1-Math.exp(-3*o);if(i+=(s-i)*c,Rm.copy(Pm).multiplyScalar(i).applyQuaternion(a).add(n.positionMeters),t){let t=1-Math.exp(-5*o);e.position.lerp(Rm,t)}else e.position.copy(Rm),t=!0;Vm.copy(Hm).applyQuaternion(a),e.up.copy(Vm),Bm.copy(Um).applyQuaternion(a),zm.copy(n.positionMeters).addScaledVector(Bm,Fm),e.lookAt(zm)}function o(t,n){Rm.copy(Lm).applyQuaternion(n).add(t.positionMeters),e.position.copy(Rm),e.quaternion.copy(n)}return{updateCameraFollowingShip(e,t,r){n===`cockpit`?o(e,t):a(e,t,r)},toggleCameraViewMode(){return n=n===`thirdPersonChase`?`cockpit`:`thirdPersonChase`,t=!1,n},getCameraViewMode(){return n},setCoverZoomActive(e){r=e}}}var Gm=new q(16720384),Km=new q(16763904),qm=6,Jm=2.4,Ym=.7,Xm=.02,Zm=null;function Qm(e,t){if(!Zm)return;if(e<Xm){Zm.visible=!1;return}Zm.visible=!0;let n=Jm*e,r=Ym*(.4+.6*e);Zm.scale.set(r,r,n),Zm.position.z=2.4+n/2;let i=(Math.sin(t*qm)+1)/2;Zm.material.color.lerpColors(Gm,Km,i)}function $m(){let e=-2.7,t=2.8,n=.45,r=new Float32Array([n,0,e,3.6,0,t,n,0,t,-.45,0,e,-.45,0,t,-3.6,0,t]),i=new Er;return i.setAttribute(`position`,new dr(r,3)),i.computeVertexNormals(),i}function eh(){let e=new wn,t=new Ji({color:5210009,flatShading:!0}),n=new Ji({color:2899536,flatShading:!0,side:2}),r=new Ji({color:1127253,emissive:3386111,emissiveIntensity:1.5}),i=new J(new ji(.8,7,6),t);i.rotation.x=-Math.PI/2,e.add(i);let a=new J($m(),n);e.add(a);let o=new J(new Li(.5,8,6),r);return o.position.set(0,0,2.1),o.scale.z=.6,e.add(o),Zm=new J(new Pi(.5,0),new Lr({color:Gm})),Zm.visible=!1,e.add(Zm),e}var th=document.getElementById(`gameRenderCanvas`),nh=document.getElementById(`viewHudOverlay`),rh=document.getElementById(`controlsOverlay`),ih=new ml({canvas:th,antialias:!0});ih.setPixelRatio(Math.min(window.devicePixelRatio,2));var ah=new Mn;ah.background=lf();var oh=4/3,sh=140,ch=.42,lh=132,uh=8,dh=new Ea(70,oh,.1,8e3),fh=Math.min(window.innerWidth,window.innerHeight),ph=fh;function mh(e,t,n,r,i){e.style.position=`fixed`,e.style.left=`${t}px`,e.style.top=`${n}px`,e.style.width=`${r}px`,e.style.height=`${i}px`,e.style.right=`auto`,e.style.bottom=`auto`}function hh(){let e=window.innerWidth,t=window.innerHeight,n=t>=e,r,i;if(n){i=Math.min(Math.floor(t*ch),Math.floor(e/oh)),r=Math.floor(i*oh);let n=Math.floor((e-r)/2);for(let e of[th,nh])mh(e,n,0,r,i);let a=i+uh,o=Math.max(0,t-a),s=Math.max(0,Math.min(o,e-lh)),c=a+Math.floor((o-s)/2);mh(jh,e-s,c,s,s);let l=e-s,u=Math.floor(o*.6);mh(Ch,0,a,l,u),mh(wh,0,a+u,l,o-u)}else{let n=Math.min(t,Math.floor((e-sh)/2.333333333333333));i=n,r=Math.floor(n*oh);let a=n,o=e-r-a,s=Math.floor((t-n)/2);for(let e of[th,nh])mh(e,o,s,r,i);mh(jh,o+r,s,a,a);let c=Math.floor(t*.6);mh(Ch,0,0,o,c),mh(wh,0,c,o,t-c)}fh=r,ph=i,ih.setSize(r,i),dh.aspect=r/i,dh.updateProjectionMatrix()}var gh=new W(.55,.35,.4).normalize(),_h=new ka(16773853,3.2);_h.position.copy(gh).multiplyScalar(1e3),ah.add(_h);var vh=new ma(6981312,1450042,.275);ah.add(vh);var yh=new J(new Li(120,24,16),new Lr({color:16773320}));yh.position.copy(gh).multiplyScalar(4500),ah.add(yh);var bh={asteroids:Wl(ah),enemyShips:[]};qu(bh.asteroids);var $=_l(),xh=eh();ah.add(xh);var Sh=_m(),Ch=document.createElement(`div`);Ch.className=`controlClusterLeft`,rh.appendChild(Ch);var wh=document.createElement(`div`);wh.className=`controlClusterRight`,rh.appendChild(wh);var Th=Nm(Ch),Eh=tp(nh),Dh=rp(nh),Oh=Wm(dh),kh=ym(nh),Ah=xm(),jh=document.createElement(`div`);jh.className=`radarRegion`,rh.appendChild(jh);var Mh=Am(jh);hh(),window.addEventListener(`resize`,hh);var Nh=Af(ah),Ph=$f(ah),Fh=gm(ah),Ih=$d(nh),Lh=ef(nh),Rh=rf(nh),zh=uf(rh),Bh=Kd(),Vh=document.createElement(`button`);Vh.className=`soundToggleButton`,Vh.textContent=`SOUND: ON`,nh.appendChild(Vh);function Hh(){Vh.textContent=Bh.toggleMuted()?`SOUND: OFF`:`SOUND: ON`}Vh.addEventListener(`click`,e=>{e.stopPropagation(),Hh()}),window.addEventListener(`keydown`,e=>{e.code===`KeyM`&&Hh()});var Uh=!1;function Wh(){Uh||(Uh=!0,Bh.resumeAfterFirstUserGesture())}window.addEventListener(`pointerdown`,Wh),window.addEventListener(`keydown`,Wh);var Gh=document.createElement(`button`);Gh.className=`cameraViewToggleButton`,Gh.textContent=`VIEW: CHASE`,nh.appendChild(Gh);function Kh(){let e=Oh.toggleCameraViewMode();Gh.textContent=e===`cockpit`?`VIEW: COCKPIT`:`VIEW: CHASE`,xh.visible=e!==`cockpit`,Dh.setCockpitFrameVisible(e===`cockpit`)}Gh.addEventListener(`click`,Kh),window.addEventListener(`keydown`,e=>{e.code===`KeyC`&&Kh()});var qh=document.createElement(`div`);qh.className=`waveAnnouncementBanner`,nh.appendChild(qh);function Jh(e){qh.textContent=e,qh.classList.add(`waveAnnouncementBannerVisible`)}function Yh(){qh.classList.remove(`waveAnnouncementBannerVisible`)}var Xh=!1,Zh=null,Qh=new W,$h=!1,eg=0,tg=.9,ng=.05,rg=new Er().setFromPoints([new W,new W]),ig=new mi(rg,new oi({color:5627391,transparent:!0,opacity:.8}));ig.visible=!1,ah.add(ig);var ag=new W;function og(e){Zh=e,Ol($,ag),Cu(e,bh.enemyShips,$.positionMeters,ag,Qh),Xh=!0,$h=!1,eg=.5,Th.setThrottleFraction(0),Th.setStrafeJoystickVisible(!0),Oh.setCoverZoomActive(!0)}function sg(){Xh=!1,Zh=null,ig.visible=!1,Th.setStrafeJoystickVisible(!1),Oh.setCoverZoomActive(!1)}th.addEventListener(`pointerdown`,e=>{let t=pu(e.clientX/window.innerWidth*2-1,-(e.clientY/window.innerHeight)*2+1,dh,bh.asteroids);t&&($.positionMeters.distanceTo(t.positionMeters)-t.currentRadiusMeters>gl.tractorGrabMaxRangeMeters||og(t))});var cg=1,lg=`waveIntro`,ug=2.5;function dg(e){let t=[],n=e<=2?2+e:2,r=e>=3?Math.min(5,e-1):0,i=e>=5?Math.min(5,e-4):0;for(let e=0;e<n;e++)t.push(`dumbPatrol`);for(let e=0;e<r;e++)t.push(`orbitStrafe`);for(let e=0;e<i;e++)t.push(`coverHunter`);return t}var fg=new W;function pg(e){for(let t=0;t<20;t++)if(e.set(Math.random()-.5,Math.random()-.5,Math.random()-.5).normalize().multiplyScalar(450+Math.random()*200),e.distanceTo($.positionMeters)>=250)return e;return e}var mg=new WeakMap;function hg(e){for(let t of dg(e)){let e=Np(t,pg(fg),ah);mg.set(e,{nextLaserFireTimeSeconds:0,nextMissileFireTimeSeconds:0,fireIntent:cp()}),bh.enemyShips.push(e)}}function gg(){for(let e of bh.enemyShips)ah.remove(e.renderObject);bh.enemyShips.length=0}function _g(){$.positionMeters.set(0,0,0),$.velocityMetersPerSecond.set(0,0,0),$.orientation.identity(),$.currentPitchRateRadiansPerSecond=0,$.currentYawRateRadiansPerSecond=0,xh.position.copy($.positionMeters),xh.quaternion.copy($.orientation),Sh.restoreForWaveRestart(),sg()}function vg(){Yh();let e=pf(ff,Math.random);zh.showPowerUpChoices(e,yg)}function yg(e){e.applyToPlayerStats(),zh.hide(),cg+=1,Jh(`WAVE ${cg}`),lg=`waveIntro`,ug=2.5}function bg(e){if(ug-=e,lg===`waveIntro`&&ug<=0){Yh(),hg(cg),lg=`waveActive`,Bh.playWaveStartSound();return}if(lg===`waveActive`){if(Sh.isPlayerDestroyed()){Jh(`SHIP DESTROYED — RESTARTING WAVE`),gg(),lg=`playerDestroyed`,ug=3,Bh.playPlayerDestroyedSound();return}bh.enemyShips.filter(e=>!e.isDestroyed).length===0&&(Jh(`WAVE ${cg} CLEARED`),gg(),lg=`waveCleared`,ug=3,Bh.playWaveClearedSound());return}if(lg===`waveCleared`&&ug<=0){vg(),lg=`powerUpSelection`;return}lg===`playerDestroyed`&&ug<=0&&(_g(),Jh(`WAVE ${cg}`),lg=`waveIntro`,ug=2.5)}var xg=0,Sg={onEnemyHitByPlayer(e,t){e.isDestroyed||(sp(e,t),e.isDestroyed?(ah.remove(e.renderObject),Bh.playExplosionSound()):Bh.playEnemyHitSound())},onAsteroidHit(e,t,n){su(e,n,t,ah)},onPlayerHit(e){Sh.applyIncomingWeaponDamage(e,xg),Bh.playPlayerHitSound()}},Cg=0,wg=0,Tg=null,Eg=new W,Dg=new W,Og=new W;function kg(){Ol($,ag),Tg=td($.positionMeters,ag,bh.enemyShips,bh.asteroids);let e=Tg;e!==null&&(Dg.copy($.positionMeters).addScaledVector(ag,4),xg>=Cg&&(gf(Dg,e.positionMeters,e.velocityMetersPerSecond,Yu.boltSpeedMetersPerSecond,Eg),Nh.tryFireLaserVolley(Dg,Eg,Yu,!0,xg),Cg=xg+Yu.fireCooldownSeconds,Bh.playLaserZapSound()),xg>=wg&&(gf(Dg,e.positionMeters,e.velocityMetersPerSecond,Xu.missileSpeedMetersPerSecond,Eg),Ph.tryFireMissile(Dg,Eg,Xu,!0,xg,e),wg=xg+Xu.fireCooldownSeconds,Bh.playMissileLaunchSound()))}function Ag(e){for(let t of bh.enemyShips){if(t.isDestroyed)continue;let n=mg.get(t);n&&(Xp(t,bh.asteroids,$.positionMeters,e,n.fireIntent),Og.copy(t.positionMeters).addScaledVector(n.fireIntent.aimDirectionWorld,5),n.fireIntent.wantsToFireLaser&&xg>=n.nextLaserFireTimeSeconds&&(Nh.tryFireLaserVolley(Og,n.fireIntent.aimDirectionWorld,Zu,!1,xg),n.nextLaserFireTimeSeconds=xg+Zu.fireCooldownSeconds),n.fireIntent.wantsToFireMissile&&xg>=n.nextMissileFireTimeSeconds&&(Ph.tryFireMissile(Og,n.fireIntent.aimDirectionWorld,Qu,!1,xg),n.nextMissileFireTimeSeconds=xg+Qu.fireCooldownSeconds))}}var jg=new W,Mg=new W,Ng=new Dt,Pg=new W,Fg=new W(0,1,0),Ig=.1;function Lg(e,t,n,r){if(jg.copy(Qh).sub(e.positionMeters).normalize(),Pg.copy(Fg).applyQuaternion($.orientation),t!==0&&(Ng.setFromAxisAngle(Pg,t*tg*r),jg.applyQuaternion(Ng)),n!==0&&(Mg.crossVectors(jg,Pg),Mg.lengthSq()>1e-8)){Mg.normalize();let e=jg.angleTo(Pg),t=n*tg*r;t=t>0?Math.min(t,Math.max(0,e-Ig)):Math.max(t,-Math.max(0,Math.PI-e-Ig)),Ng.setFromAxisAngle(Mg,t),jg.applyQuaternion(Ng)}Qh.copy(e.positionMeters).addScaledVector(jg,Su(e))}var Rg=.05;function zg(e,t,n){return Math.abs(e)>Rg||Math.abs(t)>Rg||Tg===null||Tg.isDestroyed?{pitchInput:e,yawInput:t}:sd(n,$.positionMeters,Tg.positionMeters,hl)}var Bg=new W(1,0,0),Vg=new Dt,Hg=new Dt;function Ug(e,t,n,r){if(t===0&&n===0)return;let i=hl.maxTurnRateRadiansPerSecond*r;Vg.setFromAxisAngle(Fg,-n*i),Hg.setFromAxisAngle(Bg,t*i),e.multiply(Vg).multiply(Hg).normalize()}function Wg(e){let t=Mh.getCommandedOrientation(),n=1-Math.exp(-6*e),r=$.orientation.angleTo(t);if(r>1e-4){let i=hl.maxTurnRateRadiansPerSecond*e,a=Math.min(r*n,i);$.orientation.rotateTowards(t,a)}$.currentPitchRateRadiansPerSecond=0,$.currentYawRateRadiansPerSecond=0}function Gg(e){let t=Th.readFlightControlInput(),n=Mh.getCommandedOrientation();if(!Mh.isSteeringDrag()){let r=zg(t.pitchInput,t.yawInput,n);Ug(n,r.pitchInput,r.yawInput,e)}if(Wg(e),Xh&&Zh)if(Zh.isDestroyed)sg();else if(t.throttleFraction>ng)sg();else{let t=Th.readStrafeControlInput();if((Math.abs(t.strafeXInput)>.1||Math.abs(t.strafeYInput)>.1)&&($h=!0,Lg(Zh,t.strafeXInput,t.strafeYInput,e)),!$h&&(eg-=e,eg<=0)){eg=.5;let e=Zh.positionMeters;bh.enemyShips.some(t=>!t.isDestroyed&&t.positionMeters.distanceTo(e)<=jl.missileEffectiveLongRangeMeters)&&(Ol($,ag),Cu(Zh,bh.enemyShips,$.positionMeters,ag,Qh))}Pu($,Qh,Zh.positionMeters,gl,e);return}Al($,{pitchInput:0,yawInput:0,throttleFraction:t.throttleFraction},hl,e),Xl($.positionMeters,$.velocityMetersPerSecond,e)}var Kg=1/60,qg=0,Jg=performance.now();function Yg(e){xg+=e,bg(e),Gg(e),lg===`waveActive`?(kg(),Ag(e)):Tg=null,Nh.updateLaserBolts(e,bh.asteroids,bh.enemyShips,$.positionMeters,Sg),Ph.updateMissiles(e,bh.asteroids,bh.enemyShips,$.positionMeters,Sg),Gl(bh.asteroids,e),cu(e),Sh.updateShieldRegeneration(e,xg),Ah.updateRadarContacts(bh.enemyShips,bh.asteroids,$.positionMeters,xg)}var Xg=0;function Zg(e){let t=1-Math.exp(-25*e);if(xh.position.lerp($.positionMeters,t),xh.quaternion.slerp($.orientation,t),Qm(Th.readFlightControlInput().throttleFraction,xg),Fh.updateEnemyConditionBars(bh.enemyShips,dh),Xh&&Zh){ig.visible=!0;let e=rg.attributes.position;e.setXYZ(0,$.positionMeters.x,$.positionMeters.y,$.positionMeters.z),e.setXYZ(1,Zh.positionMeters.x,Zh.positionMeters.y,Zh.positionMeters.z),e.needsUpdate=!0}else ig.visible=!1;Xg-=e,Xg<=0&&(Xg=.25,Ol($,ag),Ju(bh.asteroids,bh.enemyShips,$.positionMeters,ag,bh.asteroids,gl.tractorGrabMaxRangeMeters)),Lh.setEngaged(Tg!==null),kh.updatePlayerConditionDisplay(Sh.getShieldPointsFraction(),Sh.getHullPointsFraction()),Mh.updateRadarDisplay(Ah.getContactReadings(),$,Ah.getRecentActiveEnemyCount(),Ah.hasUnresolvedEnemies(),xg);let n=1-(Cg-xg)/Yu.fireCooldownSeconds,r=1-(wg-xg)/Xu.fireCooldownSeconds;Eh.updateWeaponCooldownIndicators(n,r)}function Qg(e){requestAnimationFrame(Qg);let t=Math.min((e-Jg)/1e3,.25);for(Jg=e,qg+=t;qg>=Kg;)Yg(Kg),qg-=Kg;Zg(t),Oh.updateCameraFollowingShip($,Mh.getCommandedOrientation(),t),dh.updateMatrixWorld(),Ih.updateEnemyTargetRings(Ah.getContactReadings(),dh,fh,ph,Tg===null?null:Tg.enemyShipId),Rh.updateSunLensFlare(yh.position,dh,fh,ph),ih.render(ah,dh),Mh.renderRadar()}Jh(`WAVE ${cg}`),requestAnimationFrame(Qg);